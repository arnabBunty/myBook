...
const validateName=RegExp('^([A-Z]{1})+([a-z]{2,10})$');
    ...
    return (
        <div className="register">
            <div className="register__container">
                ...
                <form onSubmit={submitHandler}>
                    <center>
                        <input type="name" name='fname' className="register__name" placeholder="First Name" onChange={handleChange} />
      
                        <input type="name" name='lname'  className="register__name" placeholder="Last Name" onChange={handleChange} />
                        
                        {inputState.isError.fname.length>0 && (
        <span className='err'><br></br>{inputState.isError.fname}</span>
      )}
      
      {inputState.isError.lname.length>0 && (
        <span className='err'><br></br>{inputState.isError.lname}</span>
      )}
                    </center>
                    <center>
      ...
      { inputState.isError.pass.length>0&& (
        <span className='err'>{inputState.isError.pass}</span>
                    ...
                    <center>
                        <button  type="submit" disabled={inputState.isError.pass.length>1 || inputState.isError.fname.length>1 || inputState.isError.email.length>1 || inputState.isError.lname.length>1 || !inputState.pass || !inputState.fname || !inputState.email || !inputState.lname} className="register__register">Register</button>
                    </center>
                </form>
            </div>
        </div>
